...
### House Robber III
- **Example:** tree `[3,2,3,null,3,null,1]` → `7` (rob the root's two grandchildren-level nodes worth 3+1, plus root's other subtree... concretely: rob nodes summing to 7)
