...
### Combination Sum II (no repetition, has duplicate inputs)
...
### Valid Sudoku
- **Example:** a 9x9 partially-filled board → `true`/`false` for whether the filled cells violate no rule
